...
<div class="sidebar" id="sidebar">
    ...
    <div class="nav-item slide-in" style="animation-delay: 0.1s">
        <a href="my_batches.php" target="content-frame" class="nav-link">
            <i class="fas fa-users"></i>
            <span class="link-text">My Batches</span>
        </a>
    </div>
    
    <div class="nav-item slide-in" style="animation-delay: 0.2s">
        <a href="mark_attendance.php" target="content-frame" class="nav-link">
            <i class="fas fa-check-circle"></i>
            <span class="link-text">Mark Attendance</span>
        </a>
    </div>
    
    <div class="nav-item slide-in" style="animation-delay: 0.3s">
        <a href="view_attendance.php" target="content-frame" class="nav-link">
    ...
    <div class="nav-item slide-in" style="animation-delay: 0.4s">
        <a href="report_attendance.php" target="content-frame" class="nav-link">
            <i class="fas fa-chart-bar"></i>
            <span class="link-text">Report Attendance</span>
        </a>
    </div>
    
    <div class="nav-item slide-in" style="animation-delay: 0.5s">
        <a href="change_passwords.php" target="content-frame" class="nav-link">
...
<div class="main-content" id="main-content">
    <iframe name="content-frame" id="content-frame" src="welcome_student.php"></iframe>
</div>
        ...
        frame.onload = function() {
            if (frame.contentDocument.body.innerHTML.trim() === '') {
                ...
                <div class="welcome-container fade-in">
                    ...
                    <p>Track your attendance and manage your academic progress</p>
