...
$query = "SELECT name FROM teachers WHERE username=?";
...
<head>
    ...
    <title>Change Password | Faculty Dashboard</title>
...
<body>
    <div class="container">
        <div class="dashboard-header fade-in">
            <div style="display: flex; align-items: center; gap: 20px;">
                ...
                <div>
                    ...
                    <p style="color: var(--text-muted);">Faculty Member: <?php echo htmlspecialchars($teacher_name); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="card fade-in">
            ...
            <form method="POST" action="change_passwordt.php">
